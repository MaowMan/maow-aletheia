<script>
    ...
    import { Icon, Button ,Progress } from "svelma";
    ...
    async function check(target) {
        const url = new URL(`${meta.proxy}/https://nhentai.net/api/gallery/${target}`);
...
<div class="columns">
    <div class="column is-half">
        <Progressbar bind:maxvalue = {processing.maxvalue} bind:value = {processing.value}></Progressbar>
    </div>
</div>
{:else}
<div class="buttons">
    <Button iconLeft="download" type="is-link" on:click={()=>main()}>下載</Button>
</div>
{/if}
